...
class Trajectory(object):
    ...
    def __init__(self, n_dim, n_state, bounds=None):
        ...
        self._n_dim = n_dim     #Ziyi: n_dim = the number of shapes/objects in the env
        self._n_state = n_state #Ziyi: n_state=4: 2 for coordinate/position, another 2 for velocity
...
class ConstantSpeedTrajectory(Trajectory):
    ...
    def _forward(self, state):
        ...
        :return:
        """
        pos, vel = np.split(state, 2, -1)#Split an array into multiple sub-arrays as views into ary.
